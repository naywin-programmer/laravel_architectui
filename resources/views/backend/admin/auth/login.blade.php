                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.login') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-12 col-form-label"><strong>{{ __('E-Mail Address') }}</strong></label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-12 col-form-label"><strong>{{ __('Password') }}</strong></label>
